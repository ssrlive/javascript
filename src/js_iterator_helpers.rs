...
pub fn initialize_iterator_helpers<'gc>(ctx: &GcContext<'gc>, env: &JSObjectDataPtr<'gc>) -> Result<(), crate::error::JSError> {
    ...
    let mk_method = |native: &str, display: &str, len: f64| -> Result<JSObjectDataPtr<'gc>, crate::error::JSError> {
        ...
        if let Some(fp) = func_proto {
            obj.borrow_mut(ctx).prototype = Some(fp);
        }
        obj.borrow_mut(ctx)
            .set_closure(Some(new_gc_cell_ptr(ctx, Value::Function(native.to_string()))));
        let nd = create_descriptor_object(ctx, &Value::String(utf8_to_utf16(display)), false, false, true)?;
        define_property_internal(ctx, &obj, "name", &nd)?;
        let ld = create_descriptor_object(ctx, &Value::Number(len), false, false, true)?;
        define_property_internal(ctx, &obj, "length", &ld)?;
        Ok(obj)
    };
    ...
    // =======================================================================
    let iterator_ctor = new_js_object_data(ctx);
    if let Some(fp) = func_proto {
        iterator_ctor.borrow_mut(ctx).prototype = Some(fp);
    }
    ...
    slot_set(ctx, &iterator_ctor, InternalSlot::IsConstructor, &Value::Boolean(true));
    slot_set(ctx, &iterator_ctor, InternalSlot::Callable, &Value::Boolean(true));
    iterator_ctor
        .borrow_mut(ctx)
        .set_closure(Some(new_gc_cell_ptr(ctx, Value::Function("Iterator".to_string()))));

    // Iterator.name = "Iterator"
    let name_d = create_descriptor_object(ctx, &Value::String(utf8_to_utf16("Iterator")), false, false, true)?;
    define_property_internal(ctx, &iterator_ctor, "name", &name_d)?;
    // Iterator.length = 0
    let len_d = create_descriptor_object(ctx, &Value::Number(0.0), false, false, true)?;
    define_property_internal(ctx, &iterator_ctor, "length", &len_d)?;

    // Iterator.prototype = %IteratorPrototype%  { writable: false, enumerable: false, configurable: false }
    let proto_desc = create_descriptor_object(ctx, &Value::Object(iter_proto), false, false, false)?;
    define_property_internal(ctx, &iterator_ctor, "prototype", &proto_desc)?;
    ...
    // =======================================================================
    {
        ...
        let desc = accessor_descriptor(ctx, &getter, &setter, false, true)?;
        define_property_internal(ctx, &iter_proto, "constructor", &desc)?;
    }
    ...
    if let Some(tag_sym) = get_well_known_symbol(env, "toStringTag") {
        ...
        let desc = accessor_descriptor(ctx, &getter, &setter, false, true)?;
        define_property_internal(ctx, &iter_proto, PropertyKey::Symbol(tag_sym), &desc)?;
    }
    ...
    for &(native, display, len) in lazy_methods {
        ...
        object_set_key_value(ctx, &iter_proto, display, &Value::Object(m))?;
        iter_proto
            .borrow_mut(ctx)
    ...
    // =======================================================================
    {
        ...
        object_set_key_value(ctx, &iterator_ctor, "from", &Value::Object(from_obj))?;
        iterator_ctor
            .borrow_mut(ctx)
    ...
    // =======================================================================
    let helper_proto = new_js_object_data(ctx);
    helper_proto.borrow_mut(ctx).prototype = Some(iter_proto);

    // next method
    {
        let next_m = mk_method("IteratorHelper.prototype.next", "next", 0.0)?;
        object_set_key_value(ctx, &helper_proto, "next", &Value::Object(next_m))?;
        helper_proto
            .borrow_mut(ctx)
    ...
    // return method
    {
        ...
        object_set_key_value(ctx, &helper_proto, "return", &Value::Object(ret_m))?;
        helper_proto
            .borrow_mut(ctx)
    ...
    if let Some(tag_sym) = get_well_known_symbol(env, "toStringTag") {
        let td = create_descriptor_object(ctx, &Value::String(utf8_to_utf16("Iterator Helper")), false, false, true)?;
        define_property_internal(ctx, &helper_proto, PropertyKey::Symbol(tag_sym), &td)?;
    }

    slot_set(ctx, env, InternalSlot::IteratorHelperPrototype, &Value::Object(helper_proto));

    // =======================================================================
    // 8) %WrapForValidIteratorPrototype%
    // =======================================================================
    let wrap_proto = new_js_object_data(ctx);
    wrap_proto.borrow_mut(ctx).prototype = Some(iter_proto);

    {
        let next_m = mk_method("WrapForValid.prototype.next", "next", 0.0)?;
        object_set_key_value(ctx, &wrap_proto, "next", &Value::Object(next_m))?;
        wrap_proto
            .borrow_mut(ctx)
            .set_non_enumerable(PropertyKey::String("next".to_string()));
    }
    {
        ...
        object_set_key_value(ctx, &wrap_proto, "return", &Value::Object(ret_m))?;
        wrap_proto
            .borrow_mut(ctx)
            .set_non_enumerable(PropertyKey::String("return".to_string()));
    }

    slot_set(ctx, env, InternalSlot::WrapForValidIteratorProto, &Value::Object(wrap_proto));
    ...
    // =======================================================================
    {
        ...
        object_set_key_value(ctx, &iterator_ctor, "concat", &Value::Object(concat_obj))?;
        iterator_ctor
            .borrow_mut(ctx)
    ...
    // =======================================================================
    {
        ...
        object_set_key_value(ctx, &iterator_ctor, "zip", &Value::Object(zip_obj))?;
        iterator_ctor
            .borrow_mut(ctx)
    ...
    }
    {
        ...
        object_set_key_value(ctx, &iterator_ctor, "zipKeyed", &Value::Object(zipk_obj))?;
        iterator_ctor
            .borrow_mut(ctx)
    ...
    // =======================================================================
    env_set(ctx, env, "Iterator", &Value::Object(iterator_ctor))?;
...
pub fn handle_iterator_helper_dispatch<'gc>(
    ...
    match name {
        ...
        "Iterator" => Ok(Some(handle_iterator_constructor(ctx, env)?)),
        ...
        "Iterator.prototype.map" => {
            ...
            Ok(Some(create_iterator_helper(ctx, this_val, &cb, "map", 0.0, env)?))
        }
        "Iterator.prototype.filter" => {
            let cb = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(create_iterator_helper(ctx, this_val, &cb, "filter", 0.0, env)?))
        }
        "Iterator.prototype.take" => {
            ...
            let num_limit = match crate::core::to_number_with_env(ctx, env, &limit) {
                Ok(n) => n,
                Err(e) => {
                    close_underlying_iterator(ctx, &this_obj, env);
                    return Err(e);
                }
            };
            ...
            Ok(Some(create_iterator_helper(ctx, this_val, &Value::Undefined, "take", n, env)?))
        }
        "Iterator.prototype.drop" => {
            ...
            Ok(Some(create_iterator_helper(ctx, this_val, &Value::Undefined, "drop", n, env)?))
        }
        "Iterator.prototype.flatMap" => {
            let cb = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(create_iterator_helper(ctx, this_val, &cb, "flatMap", 0.0, env)?))
        }
        ...
        "Iterator.prototype.reduce" => {
            ...
            Ok(Some(handle_reduce(ctx, this_val, &reducer, initial.as_ref(), env)?))
        }
        "Iterator.prototype.toArray" => Ok(Some(handle_to_array(ctx, this_val, env)?)),
        "Iterator.prototype.forEach" => {
            let cb = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(handle_for_each(ctx, this_val, &cb, env)?))
        }
        "Iterator.prototype.some" => {
            let pred = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(handle_some(ctx, this_val, &pred, env)?))
        }
        "Iterator.prototype.every" => {
            let pred = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(handle_every(ctx, this_val, &pred, env)?))
        }
        "Iterator.prototype.find" => {
            let pred = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(handle_find(ctx, this_val, &pred, env)?))
        }

        // --- Iterator.from ---
        "Iterator.from" => {
            let arg = args.first().cloned().unwrap_or(Value::Undefined);
            Ok(Some(handle_iterator_from(ctx, &arg, env)?))
        }

        // --- IteratorHelper.prototype.next ---
        "IteratorHelper.prototype.next" => Ok(Some(handle_helper_next(ctx, this_val, env)?)),
        "IteratorHelper.prototype.return" => Ok(Some(handle_helper_return(ctx, this_val, env)?)),

        // --- WrapForValid.prototype.next ---
        "WrapForValid.prototype.next" => Ok(Some(handle_wrap_next(ctx, this_val, env)?)),
        "WrapForValid.prototype.return" => Ok(Some(handle_wrap_return(ctx, this_val, env)?)),

        // --- Iterator.concat ---
        "Iterator.concat" => Ok(Some(handle_iterator_concat(ctx, args, env)?)),

        // --- Iterator.zip / Iterator.zipKeyed ---
        "Iterator.zip" => Ok(Some(handle_iterator_zip(ctx, args, env)?)),
        "Iterator.zipKeyed" => Ok(Some(handle_iterator_zip_keyed(ctx, args, env)?)),
...
fn handle_iterator_constructor<'gc>(ctx: &GcContext<'gc>, env: &JSObjectDataPtr<'gc>) -> Result<Value<'gc>, EvalError<'gc>> {
    ...
    match new_target {
        ...
        Some(nt_rc) => {
            ...
            {
                obj.borrow_mut(ctx).prototype = Some(*ip_obj);
            }
            Ok(Value::Object(obj))
        }
    }
...
fn handle_set_constructor<'gc>(
    ...
    setter_that_ignores_prototype_properties(ctx, this_val, "constructor", val, env)
}
...
fn handle_set_to_string_tag<'gc>(
    ...
    setter_that_ignores_prototype_properties(ctx, this_val, "@@toStringTag", val, env)
}
...
fn setter_that_ignores_prototype_properties<'gc>(
    ...
    if !has_own {
        ...
        object_set_key_value(ctx, &this_obj, prop_key, val)?;
    } else {
...
fn create_iterator_helper<'gc>(
    ...
    if matches!(kind, "map" | "filter" | "flatMap") && !is_callable(callback) {
        close_underlying_iterator(ctx, &iter_obj, env);
        return Err(raise_type_error!("Expected a callable").into());
    }

    // GetIteratorDirect(this) — reads .next
    let next_method = get_next_method(ctx, &iter_obj, env)?;

    // Create the helper object
    let helper = new_js_object_data(ctx);
    if let Some(hp_val) = slot_get_chained(env, &InternalSlot::IteratorHelperPrototype)
        && let Value::Object(hp) = &*hp_val.borrow()
    {
        helper.borrow_mut(ctx).prototype = Some(*hp);
    }

    slot_set(ctx, &helper, InternalSlot::IteratorHelperKind, &Value::String(utf8_to_utf16(kind)));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperUnderlying, &Value::Object(iter_obj));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperNextMethod, &next_method);
    if !matches!(callback, Value::Undefined) {
        slot_set(ctx, &helper, InternalSlot::IteratorHelperCallback, callback);
    }
    slot_set(ctx, &helper, InternalSlot::IteratorHelperCounter, &Value::Number(0.0));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperRemaining, &Value::Number(numeric_arg));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperDone, &Value::Boolean(false));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperExecuting, &Value::Boolean(false));
...
fn handle_helper_next<'gc>(
    ...
    {
        return make_iter_result(ctx, env, &Value::Undefined, true);
    }
    ...
    slot_set(ctx, &helper, InternalSlot::IteratorHelperStarted, &Value::Boolean(true));

    // Set executing flag
    slot_set(ctx, &helper, InternalSlot::IteratorHelperExecuting, &Value::Boolean(true));

    // concat kind doesn't use underlying/next_method the same way
    if kind == "concat" {
        let result = helper_next_concat(ctx, &helper, env);
        slot_set(ctx, &helper, InternalSlot::IteratorHelperExecuting, &Value::Boolean(false));
        return result;
    }
    ...
    if kind == "zip" || kind == "zipKeyed" {
        let result = helper_next_zip(ctx, &helper, env, kind == "zipKeyed");
        slot_set(ctx, &helper, InternalSlot::IteratorHelperExecuting, &Value::Boolean(false));
        return result;
    }
    ...
    let result = match kind.as_str() {
        "map" => helper_next_map(ctx, &helper, &underlying, &next_method, env),
        "filter" => helper_next_filter(ctx, &helper, &underlying, &next_method, env),
        "take" => helper_next_take(ctx, &helper, &underlying, &next_method, env),
        "drop" => helper_next_drop(ctx, &helper, &underlying, &next_method, env),
        "flatMap" => helper_next_flat_map(ctx, &helper, &underlying, &next_method, env),
...
fn helper_next_map<'gc>(
    ...
    let result = evaluate_call_dispatch(ctx, env, next_method, Some(&Value::Object(*underlying)), &[])?;
    if iter_result_done(ctx, &result, env)? {
        mark_done(ctx, helper);
        return make_iter_result(ctx, env, &Value::Undefined, true);
    }
    let value = iter_result_value(ctx, &result, env)?;
    let counter = get_counter(helper);
    inc_counter(ctx, helper);
    ...
    let mapped = match evaluate_call_dispatch(ctx, env, &callback, None, &[value, Value::Number(counter)]) {
        Ok(v) => v,
        Err(e) => {
            close_underlying_iterator(ctx, underlying, env);
            return Err(e);
        }
    };
    make_iter_result(ctx, env, &mapped, false)
}
...
fn helper_next_filter<'gc>(
    ...
    loop {
        ...
        // IfAbruptCloseIterator: if callback throws, close the underlying iterator.
        let selected = match evaluate_call_dispatch(ctx, env, &callback, None, &[value.clone(), Value::Number(counter)]) {
            Ok(v) => v,
            Err(e) => {
                close_underlying_iterator(ctx, underlying, env);
                return Err(e);
        ...
        if to_boolean(&selected) {
            return make_iter_result(ctx, env, &value, false);
        }
    }
}
...
fn helper_next_take<'gc>(
    ...
    if remaining <= 0.0 {
        ...
        mark_done(ctx, helper);
        close_underlying_iterator_throwing(ctx, underlying, env)?;
        return make_iter_result(ctx, env, &Value::Undefined, true);
    }
    dec_remaining(ctx, helper);
    ...
    let value = iter_result_value(ctx, &result, env)?;
    make_iter_result(ctx, env, &value, false)
}
...
fn helper_next_drop<'gc>(
    ...
    slot_set(ctx, helper, InternalSlot::IteratorHelperRemaining, &Value::Number(0.0));
...
fn helper_next_flat_map<'gc>(
    ...
    loop {
        ...
        if let Some(inner_rc) = slot_get(helper, &InternalSlot::IteratorHelperInnerIter) {
            ...
            if let Value::Object(inner) = inner_val {
                let inner_next = match slot_get(helper, &InternalSlot::IteratorHelperInnerNext) {
                    Some(rc) => rc.borrow().clone(),
                    None => {
                        slot_set(ctx, helper, InternalSlot::IteratorHelperInnerIter, &Value::Null);
                        continue;
                    }
                };

                let inner_result = evaluate_call_dispatch(ctx, env, &inner_next, Some(&Value::Object(inner)), &[])?;
                if iter_result_done(ctx, &inner_result, env)? {
                    slot_set(ctx, helper, InternalSlot::IteratorHelperInnerIter, &Value::Null);
                    slot_set(ctx, helper, InternalSlot::IteratorHelperInnerNext, &Value::Null);
                    continue;
                }
                let value = iter_result_value(ctx, &inner_result, env)?;
                return make_iter_result(ctx, env, &value, false);
            }
        ...
        let (inner_obj, inner_next_method) = get_iterator_flattenable(ctx, &mapped, env)?;
        slot_set(ctx, helper, InternalSlot::IteratorHelperInnerIter, &Value::Object(inner_obj));
        slot_set(ctx, helper, InternalSlot::IteratorHelperInnerNext, &inner_next_method);
    }
}
...
fn handle_helper_return<'gc>(
    ...
    let close_result = (|| -> Result<(), EvalError<'gc>> {
        if kind == "concat" {
            ...
            {
                close_underlying_iterator_throwing(ctx, inner, env)?;
            }
            ...
            iterator_close_all(ctx, &iters, &opens, count, None, env)?;
        } else {
            let underlying = get_slot_object(&helper, &InternalSlot::IteratorHelperUnderlying)?;
            close_underlying_iterator_throwing(ctx, &underlying, env)?;
        }
    ...
    close_result?;
    make_iter_result(ctx, env, &Value::Undefined, true)
}
...
fn handle_reduce<'gc>(
    ...
    loop {
        let result = evaluate_call_dispatch(ctx, env, &next_method, Some(&Value::Object(iter_obj)), &[])?;
        if iter_result_done(ctx, &result, env)? {
            break;
        }
        let value = iter_result_value(ctx, &result, env)?;
        match &accumulator {
            ...
            Some(acc) => {
                ...
                accumulator = Some(
                    match evaluate_call_dispatch(ctx, env, reducer, None, &[acc.clone(), value, Value::Number(counter)]) {
                        Ok(v) => v,
                        Err(e) => {
                            close_underlying_iterator(ctx, &iter_obj, env);
                            return Err(e);
...
fn handle_to_array<'gc>(
    ...
    {
        arr.borrow_mut(ctx).prototype = Some(*proto);
    }
    ...
    loop {
        ...
        let value = iter_result_value(ctx, &result, env)?;
        object_set_key_value(ctx, &arr, i, &value)?;
        i += 1;
    }
    object_set_key_value(ctx, &arr, "length", &Value::Number(i as f64))?;
...
fn handle_for_each<'gc>(
    ...
    loop {
        ...
        let _ = match evaluate_call_dispatch(ctx, env, callback, None, &[value, Value::Number(counter)]) {
            Ok(v) => v,
            Err(e) => {
                close_underlying_iterator(ctx, &iter_obj, env);
                return Err(e);
...
fn handle_some<'gc>(
    ...
    loop {
        ...
        let value = iter_result_value(ctx, &result, env)?;
        // IfAbruptCloseIterator
        let test = match evaluate_call_dispatch(ctx, env, predicate, None, &[value, Value::Number(counter)]) {
            Ok(v) => v,
            Err(e) => {
                close_underlying_iterator(ctx, &iter_obj, env);
                return Err(e);
        ...
        if to_boolean(&test) {
            close_underlying_iterator_throwing(ctx, &iter_obj, env)?;
...
fn handle_find<'gc>(
    ...
    loop {
        ...
        let value = iter_result_value(ctx, &result, env)?;
        // IfAbruptCloseIterator
        let test = match evaluate_call_dispatch(ctx, env, predicate, None, &[value.clone(), Value::Number(counter)]) {
            Ok(v) => v,
            Err(e) => {
                close_underlying_iterator(ctx, &iter_obj, env);
                return Err(e);
...
fn handle_iterator_from<'gc>(ctx: &GcContext<'gc>, arg: &Value<'gc>, env: &JSObjectDataPtr<'gc>) -> Result<Value<'gc>, EvalError<'gc>> {
    // 1. If O is not an Object, throw TypeError (except strings handled via @@iterator)
    let obj = match arg {
        Value::String(_) => {
            // Strings are iterable: get their @@iterator
            let iter_obj = get_iterator_from_value(ctx, arg, env)?;
            ...
            // Otherwise wrap it
            return Ok(Value::Object(create_wrap_for_valid(ctx, &iter_obj, env)?));
        }
        Value::Object(o) => *o,
    ...
    if let Some(sym) = iter_sym {
        let method_val = crate::core::get_property_with_accessors(ctx, env, &obj, PropertyKey::Symbol(sym))?;
        match &method_val {
            ...
            _ => {
                ...
                let iter_result = evaluate_call_dispatch(ctx, env, &method_val, Some(arg), &[])?;
    ...
    Ok(Value::Object(create_wrap_for_valid(ctx, &obj, env)?))
}
...
fn create_wrap_for_valid<'gc>(
    ...
    {
        wrapper.borrow_mut(ctx).prototype = Some(*wp);
    }

    slot_set(ctx, &wrapper, InternalSlot::WrapForValidUnderlying, &Value::Object(*iter_obj));
    slot_set(ctx, &wrapper, InternalSlot::WrapForValidNextMethod, &next_method);
...
fn handle_wrap_next<'gc>(
    ...
    evaluate_call_dispatch(ctx, env, &next_method, Some(&Value::Object(underlying)), &[])
}
...
fn handle_wrap_return<'gc>(
    ...
    let ret_val = crate::core::get_property_with_accessors(ctx, env, &underlying, PropertyKey::String("return".to_string()))?;
    ...
    evaluate_call_dispatch(ctx, env, &ret_val, Some(&Value::Object(underlying)), &[])
}
...
fn handle_iterator_concat<'gc>(
    ...
    for arg in args {
        match arg {
            Value::Object(o) => {
                let method = crate::core::get_property_with_accessors(ctx, env, o, PropertyKey::Symbol(iter_sym))?;
    ...
    let iterables_arr = new_js_object_data(ctx);
    for (i, it) in iterables.iter().enumerate() {
        object_set_key_value(ctx, &iterables_arr, i, it)?;
    }
    object_set_key_value(ctx, &iterables_arr, "length", &Value::Number(iterables.len() as f64))?;
    ...
    slot_set(ctx, &helper, InternalSlot::IteratorHelperUnderlying, &Value::Object(iterables_arr));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperCounter, &Value::Number(0.0)); // current iterable index
    slot_set(
        ctx,
        &helper,
...
fn get_options_object<'gc>(ctx: &GcContext<'gc>, val: &Value<'gc>) -> Result<JSObjectDataPtr<'gc>, EvalError<'gc>> {
    match val {
        Value::Undefined => {
            let obj = new_js_object_data(ctx);
...
fn parse_zip_mode<'gc>(ctx: &GcContext<'gc>, options: &JSObjectDataPtr<'gc>, env: &JSObjectDataPtr<'gc>) -> Result<String, EvalError<'gc>> {
    let mode_val = crate::core::get_property_with_accessors(ctx, env, options, PropertyKey::String("mode".to_string()))?;
    match &mode_val {
...
fn iterator_close_all<'gc>(
    ...
    for i in (0..count).rev() {
        ...
        {
            // Mark as closed
            let _ = object_set_key_value(ctx, open_flags, i, &Value::Boolean(false));
            // Get iterator object
                ...
                && let Value::Object(iter_obj) = &*iter_ref.borrow()
            {
                ...
                // Try .return()
                match crate::core::get_property_with_accessors(ctx, env, &iter_obj, PropertyKey::String("return".to_string())) {
                    Ok(ret_val) => {
                        if is_callable(&ret_val) {
                            match evaluate_call_dispatch(ctx, env, &ret_val, Some(&Value::Object(iter_obj)), &[]) {
                                Ok(_) => {}
                                Err(e) => {
                                    if error.is_none() {
                                        error = Some(e);
...
fn if_abrupt_close_iterators<'gc>(
    ...
    if let Some(src) = source_iter {
        close_underlying_iterator(ctx, src, env);
    }
    err
}

fn handle_iterator_zip<'gc>(ctx: &GcContext<'gc>, args: &[Value<'gc>], env: &JSObjectDataPtr<'gc>) -> Result<Value<'gc>, EvalError<'gc>> {
    ...
    let options_obj = get_options_object(ctx, &options_arg)?;

    // Step 3-5: mode
    let mode = parse_zip_mode(ctx, &options_obj, env)?;

    // Step 6-9: padding (only for longest mode)
    let mut padding_arg: Option<Value<'gc>> = None;

    if mode == "longest" {
        let padding_val = crate::core::get_property_with_accessors(ctx, env, &options_obj, PropertyKey::String("padding".to_string()))?;
    ...
    let method_val = crate::core::get_property_with_accessors(ctx, env, &iterables_obj, PropertyKey::Symbol(iter_sym))?;
    ...
    let source_result = evaluate_call_dispatch(ctx, env, &method_val, Some(&Value::Object(iterables_obj)), &[])?;
    ...
    let source_next = get_next_method(ctx, &source_iter, env)?;

    // Collect iterators
    let iters_arr = new_js_object_data(ctx);
    let nexts_arr = new_js_object_data(ctx);
    let opens_arr = new_js_object_data(ctx);
    let mut iter_count: usize = 0;

    loop {
        let step_result = match evaluate_call_dispatch(ctx, env, &source_next, Some(&Value::Object(source_iter)), &[]) {
            Ok(v) => v,
            Err(e) => {
                return Err(if_abrupt_close_iterators(ctx, &iters_arr, iter_count, None, e, env));
            }
        };
        if iter_result_done(ctx, &step_result, env)? {
            break;
        }
        let element = match iter_result_value(ctx, &step_result, env) {
            Ok(v) => v,
            Err(e) => {
                return Err(if_abrupt_close_iterators(ctx, &iters_arr, iter_count, Some(&source_iter), e, env));
            }
        };

        // GetIteratorFlattenable(element, reject-strings) — rejects primitives
        let (inner_iter, inner_next) = match get_iterator_flattenable(ctx, &element, env) {
            Ok(pair) => pair,
            Err(e) => {
                return Err(if_abrupt_close_iterators(ctx, &iters_arr, iter_count, Some(&source_iter), e, env));
            }
        ...
        object_set_key_value(ctx, &iters_arr, iter_count, &Value::Object(inner_iter))?;
        object_set_key_value(ctx, &nexts_arr, iter_count, &inner_next)?;
        object_set_key_value(ctx, &opens_arr, iter_count, &Value::Boolean(true))?;
        iter_count += 1;
    }

    // Now handle padding for longest mode
    let padding_arr = new_js_object_data(ctx);
    if mode == "longest" {
        if let Some(pad_val) = padding_arg {
            // Get iterator for padding
            let pad_iter_result = crate::js_generator::public_get_iterator(ctx, &pad_val, env);
            match pad_iter_result {
                Ok(pad_iter) => {
                    let pad_next = match get_next_method(ctx, &pad_iter, env) {
                        Ok(n) => n,
                        Err(e) => {
                            ...
                            for i in (0..iter_count).rev() {
                                ...
                                {
                                    close_underlying_iterator(ctx, it, env);
                                }
                            }
                            return Err(e);
                        }
                    ...
                    for i in 0..iter_count {
                        if pad_exhausted {
                            object_set_key_value(ctx, &padding_arr, i, &Value::Undefined)?;
                            continue;
                        }
                        let pad_step = match evaluate_call_dispatch(ctx, env, &pad_next, Some(&Value::Object(pad_iter)), &[]) {
                            Ok(v) => v,
                            Err(e) => {
                        ...
                        let pad_done = match iter_result_done(ctx, &pad_step, env) {
                            Ok(d) => d,
                            Err(e) => {
                                for j in (0..iter_count).rev() {
                                    if let Some(ir) = object_get_key_value(&iters_arr, j)
                        ...
                        if pad_done {
                            ...
                            let pad_val_item = match iter_result_value(ctx, &pad_step, env) {
                                Ok(v) => v,
                                Err(e) => {
                                    for j in (0..iter_count).rev() {
                                        if let Some(ir) = object_get_key_value(&iters_arr, j)
                            ...
                            object_set_key_value(ctx, &padding_arr, i, &pad_val_item)?;
                        }
                    }
                    // If padding not exhausted, close it
                    if !pad_exhausted {
                        match close_underlying_iterator_throwing(ctx, &pad_iter, env) {
                            Ok(_) => {}
                            Err(e) => {
                                // IfAbruptCloseIterators
                                for j in (0..iter_count).rev() {
    ...
    slot_set(ctx, &helper, InternalSlot::IteratorHelperKind, &Value::String(utf8_to_utf16("zip")));
    slot_set(ctx, &helper, InternalSlot::ZipIterators, &Value::Object(iters_arr));
    slot_set(ctx, &helper, InternalSlot::ZipNextMethods, &Value::Object(nexts_arr));
    slot_set(ctx, &helper, InternalSlot::ZipOpenFlags, &Value::Object(opens_arr));
    slot_set(ctx, &helper, InternalSlot::ZipMode, &Value::String(utf8_to_utf16(&mode)));
    slot_set(ctx, &helper, InternalSlot::ZipPadding, &Value::Object(padding_arr));
    slot_set(
        ctx,
        &helper,
        InternalSlot::IteratorHelperRemaining,
    ...
    slot_set(ctx, &helper, InternalSlot::IteratorHelperDone, &Value::Boolean(false));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperExecuting, &Value::Boolean(false));
    slot_set(ctx, &helper, InternalSlot::IteratorHelperStarted, &Value::Boolean(false));
...
fn handle_iterator_zip_keyed<'gc>(
    ...
    let all_keys = crate::core::ordinary_own_property_keys_mc(ctx, &iterables_obj)?;

    let iters_arr = new_js_object_data(ctx);
    let nexts_arr = new_js_object_data(ctx);
    let opens_arr = new_js_object_data(ctx);
    let keys_arr = new_js_object_data(ctx);
    let padding_arr = new_js_object_data(ctx);
    let mut iter_count: usize = 0;
    ...
    for key in &all_keys {
        ...
        let desc_result = if is_proxy {
            ...
            {
                crate::js_proxy::proxy_get_own_property_is_enumerable(ctx, proxy, key)
            } else {
        ...
        let desc_enum_opt = match desc_result {
            ...
            Err(e) => {
                ...
                let opens_tmp = new_js_object_data(ctx);
                for j in 0..iter_count {
                    let _ = object_set_key_value(ctx, &opens_tmp, j, &Value::Boolean(true));
                }
                return Err(iterator_close_all(ctx, &iters_arr, &opens_tmp, iter_count, Some(e), env).unwrap_err());
            }
        };
        ...
        let val = if is_proxy {
            if let Some(proxy_cell) = slot_get(&iterables_obj, &InternalSlot::Proxy)
                && let Value::Proxy(proxy) = &*proxy_cell.borrow()
            {
                match crate::js_proxy::proxy_get_property(ctx, proxy, key) {
            ...
            match crate::core::get_property_with_accessors(ctx, env, &iterables_obj, key.clone()) {
                Ok(v) => v,
                Err(e) => {
                    let opens_tmp = new_js_object_data(ctx);
                    for j in 0..iter_count {
        ...
        let (inner_iter, inner_next) = match get_iterator_flattenable(ctx, &val, env) {
            Ok(pair) => pair,
            Err(e) => {
                let opens_tmp = new_js_object_data(ctx);
                for j in 0..iter_count {
        ...
        object_set_key_value(ctx, &keys_arr, iter_count, &key_val)?;
        object_set_key_value(ctx, &iters_arr, iter_count, &Value::Object(inner_iter))?;
        object_set_key_value(ctx, &nexts_arr, iter_count, &inner_next)?;
        object_set_key_value(ctx, &opens_arr, iter_count, &Value::Boolean(true))?;

        // Padding placeholder (filled later if mode is longest)
        object_set_key_value(ctx, &padding_arr, iter_count, &Value::Undefined)?;
        ...
        && let Some(ref po) = padding_obj
    {
        for i in 0..iter_count {
            if let Some(key_ref) = object_get_key_value(&keys_arr, i) {
                ...
                let pad_val = match crate::core::get_property_with_accessors(ctx, env, po, pad_key) {
                    Ok(v) => v,
                    Err(e) => {
                        // IfAbruptCloseIterators
                        let opens_tmp = new_js_object_data(ctx);
                ...
                let _ = object_set_key_value(ctx, &padding_arr, i, &pad_val);
            }
        }
    }
    ...
    slot_set(ctx, &helper, InternalSlot::ZipMode, &Value::String(utf8_to_utf16(&mode)));
    slot_set(ctx, &helper, InternalSlot::ZipPadding, &Value::Object(padding_arr));
    slot_set(ctx, &helper, InternalSlot::ZipKeys, &Value::Object(keys_arr));
    slot_set(
        ctx,
        &helper,
        InternalSlot::IteratorHelperRemaining,
...
fn helper_next_zip<'gc>(
    ...
    for i in 0..iter_count {
        ...
        // Call .next()
        let step_result = match evaluate_call_dispatch(ctx, env, &next_method, Some(&Value::Object(iter_obj)), &[]) {
            Ok(v) => v,
            Err(e) => {
                // Remove this iterator from open (it faulted)
                let _ = object_set_key_value(ctx, &opens, i, &Value::Boolean(false));
                // IteratorCloseAll remaining open iterators
                return Err(iterator_close_all(ctx, &iters, &opens, iter_count, Some(e), env).unwrap_err());
            }
        };

        let is_done = match iter_result_done(ctx, &step_result, env) {
            Ok(d) => d,
            Err(e) => {
                let _ = object_set_key_value(ctx, &opens, i, &Value::Boolean(false));
                return Err(iterator_close_all(ctx, &iters, &opens, iter_count, Some(e), env).unwrap_err());
        ...
        if is_done {
            ...
            match mode_str.as_str() {
                "shortest" => {
                    ...
                    mark_done(ctx, helper);
                    iterator_close_all(ctx, &iters, &opens, iter_count, None, env)?;
                    return make_iter_result(ctx, env, &Value::Undefined, true);
                }
                "longest" => {
                ...
                "strict" => {
                    if i == 0 {
                        ...
                        if !first_done_this_round {
                            ...
                            return Err(iterator_close_all(ctx, &iters, &opens, iter_count, Some(err), env).unwrap_err());
                        }
            ...
            // Get value
            let value = match iter_result_value(ctx, &step_result, env) {
                Ok(v) => v,
                Err(e) => {
                    let _ = object_set_key_value(ctx, &opens, i, &Value::Boolean(false));
                    return Err(iterator_close_all(ctx, &iters, &opens, iter_count, Some(e), env).unwrap_err());
    ...
    let result_val = if is_keyed {
            ...
            if let Some(key_ref) = object_get_key_value(&keys_obj, i) {
                ...
                match &key_val {
                    Value::String(key_s) => {
                        ...
                        object_set_key_value(ctx, &obj, &*key_utf8, results_i)?;
                    }
                    Value::Symbol(sym) => {
                        object_set_key_value(ctx, &obj, *sym, results_i)?;
                    }
                    _ => {}
                }
            }
        ...
        for (i, val) in results.iter().enumerate() {
            object_set_key_value(ctx, &arr, i, val)?;
        }
        object_set_key_value(ctx, &arr, "length", &Value::Number(results.len() as f64))?;
        Value::Object(arr)
    };

    make_iter_result(ctx, env, &result_val, false)
}
    ...
    loop {
            ...
            && !matches!(&*inner_rc.borrow(), Value::Undefined | Value::Null)
        {
            let inner = match &*inner_rc.borrow() {
                Value::Object(o) => *o,
                _ => {
                    slot_set(ctx, helper, InternalSlot::IteratorHelperInnerIter, &Value::Undefined);
                    continue;
                }
            };
            let inner_next = match slot_get(helper, &InternalSlot::IteratorHelperInnerNext) {
            ...
            let result = evaluate_call_dispatch(ctx, env, &inner_next, Some(&Value::Object(inner)), &[])?;
            if !iter_result_done(ctx, &result, env)? {
                let value = iter_result_value(ctx, &result, env)?;
                return make_iter_result(ctx, env, &value, false);
            }
            ...
            slot_set(ctx, helper, InternalSlot::IteratorHelperInnerIter, &Value::Undefined);
            slot_set(ctx, helper, InternalSlot::IteratorHelperInnerNext, &Value::Undefined);
            idx += 1.0;
            slot_set(ctx, helper, InternalSlot::IteratorHelperCounter, &Value::Number(idx));
            continue;
        }
        ...
        let iter_result = evaluate_call_dispatch(ctx, env, &stored_method, Some(&iterable_val), &[])?;
        let inner_iter = match iter_result {
            Value::Object(o) => o,
            _ => return Err(raise_type_error!("Iterator.concat: @@iterator did not return an object").into()),
        };
        let inner_next = get_next_method(ctx, &inner_iter, env)?;
        slot_set(ctx, helper, InternalSlot::IteratorHelperInnerIter, &Value::Object(inner_iter));
        slot_set(ctx, helper, InternalSlot::IteratorHelperInnerNext, &inner_next);
    }
}
...
fn accessor_descriptor<'gc>(
    ...
    object_set_key_value(ctx, &desc, "get", &Value::Object(*getter))?;
    object_set_key_value(ctx, &desc, "set", &Value::Object(*setter))?;
    object_set_key_value(ctx, &desc, "enumerable", &Value::Boolean(enumerable))?;
    object_set_key_value(ctx, &desc, "configurable", &Value::Boolean(configurable))?;
    Ok(desc)
}
...
fn get_next_method<'gc>(
    ...
    crate::core::get_property_with_accessors(ctx, env, iter_obj, PropertyKey::String("next".to_string()))
}
...
fn get_iterator_from_value<'gc>(
    ...
    crate::js_generator::public_get_iterator(ctx, val, env)
}
...
fn get_iterator_flattenable<'gc>(
    ...
    let method_val = if let Some(sym) = get_well_known_symbol(env, "iterator") {
        crate::core::get_property_with_accessors(ctx, env, &obj, PropertyKey::Symbol(sym))?
    } else {
        Value::Undefined
    };
    ...
    if let Some(m) = method {
        ...
        let iter_result = evaluate_call_dispatch(ctx, env, &m, Some(&Value::Object(obj)), &[])?;
        ...
        let next_method = get_next_method(ctx, &obj, env)?;
        Ok((obj, next_method))
    }
}

fn iter_result_done<'gc>(ctx: &GcContext<'gc>, result: &Value<'gc>, env: &JSObjectDataPtr<'gc>) -> Result<bool, EvalError<'gc>> {
    match result {
        Value::Object(o) => {
            let done_val = crate::core::get_property_with_accessors(ctx, env, o, PropertyKey::String("done".to_string()))?;
...
fn iter_result_value<'gc>(ctx: &GcContext<'gc>, result: &Value<'gc>, env: &JSObjectDataPtr<'gc>) -> Result<Value<'gc>, EvalError<'gc>> {
    match result {
        Value::Object(o) => {
            let val = crate::core::get_property_with_accessors(ctx, env, o, PropertyKey::String("value".to_string()))?;
            Ok(val)
        }
        _ => Err(raise_type_error!("Iterator result is not an object").into()),
    }
...
fn inc_counter<'gc>(ctx: &GcContext<'gc>, obj: &JSObjectDataPtr<'gc>) {
    let c = get_counter(obj) + 1.0;
    slot_set(ctx, obj, InternalSlot::IteratorHelperCounter, &Value::Number(c));
}
...
fn dec_remaining<'gc>(ctx: &GcContext<'gc>, obj: &JSObjectDataPtr<'gc>) {
    let r = get_remaining(obj) - 1.0;
    slot_set(ctx, obj, InternalSlot::IteratorHelperRemaining, &Value::Number(r));
}

fn mark_done<'gc>(ctx: &GcContext<'gc>, obj: &JSObjectDataPtr<'gc>) {
    slot_set(ctx, obj, InternalSlot::IteratorHelperDone, &Value::Boolean(true));
}
...
fn close_underlying_iterator<'gc>(ctx: &GcContext<'gc>, iter_obj: &JSObjectDataPtr<'gc>, env: &JSObjectDataPtr<'gc>) {
    // Try to call .return() if it exists (traverse prototype chain) — swallow errors
    if let Ok(ret) = crate::core::get_property_with_accessors(ctx, env, iter_obj, PropertyKey::String("return".to_string()))
        && is_callable(&ret)
    {
        let _ = evaluate_call_dispatch(ctx, env, &ret, Some(&Value::Object(*iter_obj)), &[]);
    }
}
...
fn close_underlying_iterator_throwing<'gc>(
    ...
    let ret = crate::core::get_property_with_accessors(ctx, env, iter_obj, PropertyKey::String("return".to_string()))?;
    ...
    evaluate_call_dispatch(ctx, env, &ret, Some(&Value::Object(*iter_obj)), &[])?;
    Ok(())
}
