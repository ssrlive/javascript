...
fn bigint_global_and_prototype_to_string_value_of() {
    ...
    let r1 = evaluate_script("BigInt('123')");
    match r1 {
    ...
    let r2 = evaluate_script("BigInt(42)");
    match r2 {
    ...
    let r3 = evaluate_script("String(123n)");
    match r3 {
    ...
    let r4 = evaluate_script("BigInt(7) === 7n");
    match r4 {
    ...
    let r5 = evaluate_script("Object(123n).toString()");
    match r5 {
        Ok(Value::String(s)) => assert_eq!(String::from_utf16_lossy(&s), "123"),
    ...
    let r6 = evaluate_script("Object(7n).valueOf() === 7n");
    match r6 {
        Ok(Value::Boolean(b)) => assert!(b),
